...
| 하드웨어타입 | 프로토콜타입 | 하드웨어길이 | 프로토콜길이 | Operation | SM | SI | DM | DI |
| ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- |
| 이더넷=1 | IPv4=0800H | MAC길이6 | IP길이<br>4 | 1=요청,<br>2=응답 | 소스MAC | 소스ip | 응답MAC | 응답IP |
| 2btye | 2btye | 1btye | 1btye | 2btye | 6btye | 4btye | 6btye | 4btye |
...
* 구성요소
	...
	* Type or Length(2byte): 데이터의 크기 및 패킷 종류 정의
